...
if not args.target_cpu.startswith("x86_64"):
    ...
    if platform.system() == "Darwin":
        ...
        cmake_args.extend([
            ...
            "-DCMAKE_CROSSCOMPILING=True",
            f"-DCMAKE_AR=/usr/{gnu_prefix}/bin/{gnu_prefix}-ar",
            f"-DCMAKE_LINKER=/usr/{gnu_prefix}/bin/{gnu_prefix}-ld",
            f"-DCMAKE_RANLIB=/usr/{gnu_prefix}/bin/{gnu_prefix}-ranlib",
            f"-DCMAKE_STRIP=/usr/{gnu_prefix}/bin/{gnu_prefix}-strip",
            f"-DCMAKE_C_COMPILER_AR=/usr/{gnu_prefix}/bin/{gnu_prefix}-ar",
            f"-DCMAKE_C_COMPILER_RANLIB=/usr/{gnu_prefix}/bin/{gnu_prefix}-ranlib",
            f"-DCMAKE_CXX_COMPILER_AR=/usr/{gnu_prefix}/bin/{gnu_prefix}-ar",
            f"-DCMAKE_CXX_COMPILER_RANLIB=/usr/{gnu_prefix}/bin/{gnu_prefix}-ranlib",
